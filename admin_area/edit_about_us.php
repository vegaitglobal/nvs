...
<i class="fa fa-dashboard" ></i> Dashboard / Uredi O nama
...
<i class="fa fa-money fa-fw"></i> Uredi O nama
...
<label class="col-md-3 control-label"> O nama: naslov : </label>
...
<label class="col-md-3 control-label"> O nama: kratak opis : </label>
...
<label class="col-md-3 control-label"> O nama: Detaljno : </label>
...
<input type="submit" name="submit" value="Ažuriraj O nama" class="btn btn-primary form-control">
