...
<i class="fa fa-dashboard" ></i> Dashboard / Uredi kontakt
...
<i class="fa fa-money fa-fw"></i> Uredi kontakt 
...
<label class="col-md-3 control-label"> Kontakt: Email: </label>
...
<label class="col-md-3 control-label"> Kontakt: naslov: </label>
...
<label class="col-md-3 control-label"> Kontakt: opis: </label>
...
<input type="submit" name="submit" class="btn btn-primary form-control" value=" Uredi kontakt ">
