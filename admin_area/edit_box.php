...
<i class="fa fa-dashboard"></i> Dashboard / Uredi Box
...
<i class="fa fa-money fa-fw"></i> Uredi Box
...
<label class="col-md-3 control-label">Box naslov : </label>
...
<label class="col-md-3 control-label">Box sadržaj : </label>
...
<input type="text" name="box_url" value="<?php echo $box_url; ?>" class="form-control" >
...
<input type="submit" name="update" value="Uredi Box" class="btn btn-primary form-control">
