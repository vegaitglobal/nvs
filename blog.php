...
$(document).ready(function(){
  ...
  function getProducts(){
    ...
    url:"load-blog.php",  
    method:"POST",  
    data: sPath+'sAction=getPaginatorBlog',  
    success:function(data){
        $('.pagination').html('');  
