...
<input type="text" class="form-control" id="dev-table-filter" data-action="filter" data-filters="#dev-manufacturer" placeholder="nađi organizaciju">
...
$get_manfacturer = "select * from organizations where manufacturer_top='yes'";
...
$get_manfacturer = "select * from organizations where manufacturer_top='no'";
...
<input type="text" class="form-control" id="dev-table-filter" data-action="filter" data-filters="#dev-p-cats" placeholder="nađi programe">
...
$get_p_cats = "select * from product_categories where p_cat_top='Da'";
...
$get_p_cats = "select * from product_categories where p_cat_top='Ne'";
